...
export default function AdminLayout({
  ...
  const menu = [
    { name: "Dashboard", path: "/admin/dashboard", subtitle: "Ringkasan sistem", icon: LayoutDashboard },
    { name: "DUDI", path: "/admin/dudi", subtitle: "Manajemen DUDI", icon: Building2 },
    { name: "Pengguna", path: "/admin/pengguna", subtitle: "Manajemen user", icon: UserCog },
    { name: "Pengaturan", path: "/admin/pengaturan", subtitle: "Konfigurasi sistem", icon: Settings },
  ]
